namespace CcsData.Models
{
    ...
    public class Employment
    {
        ...
        [ForeignKey("CoApplicantId")]
        public virtual CcsData.Models.CoApplicant CoApplicant { get; set; }

        public virtual int? CoApplicantId { get; set; }
        ...
        [Key]
        public virtual int Employment_Id { get; set; }
