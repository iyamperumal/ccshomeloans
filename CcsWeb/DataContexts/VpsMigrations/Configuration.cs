namespace CcsWeb.DataContexts.VpsMigrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<VpsContext>
    {
        public Configuration()
        {
            base.AutomaticMigrationsEnabled = true;
            base.MigrationsDirectory = @"DataContexts\VpsMigrations";
        }

        protected override void Seed(VpsContext context)
        {
