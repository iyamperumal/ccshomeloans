namespace CcsWeb.DataContexts
{
    ...
    public class CcsLocalDbContext : IdentityDbContext<ApplicationUser>
    {
        public CcsLocalDbContext() : base("DefaultConnection", false)
        {
            base.Configuration.LazyLoadingEnabled = false;
        }

        public static CcsLocalDbContext Create() => 
            new CcsLocalDbContext();
