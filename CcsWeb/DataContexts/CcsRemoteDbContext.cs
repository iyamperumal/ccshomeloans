namespace CcsWeb.DataContexts
{
    ...
    public class CcsRemoteDbContext : IdentityDbContext<ApplicationUser>
    {
        public CcsRemoteDbContext() : base("ArvixeCcshl1Con", false)
        {
        }
        ...
        public DbSet<VariableBackup> VariableBacks { get; set; }
